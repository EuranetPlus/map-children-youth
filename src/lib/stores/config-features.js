export const config = {
	mapTitle: 'map-youth-children', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'https://map-children-youth.vercel.app/', // The url provided when deploying the map on Vercel
